...
import com.AbilisDownload.filedownload.models.Download;
...
public class DownloadService extends IntentService {
    ...
    private void initDownload(){
        ...
        Retrofit retrofit = new Retrofit.Builder()
                .baseUrl("http://192.168.20.3:8000/media/")
                .build();
    ...
    private void downloadFile(ResponseBody body) throws IOException {
        ...
        File outputFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "file.pptx");
